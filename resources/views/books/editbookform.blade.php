...
<div class="row mt-5">
    <div class="col mt-5 mb-5">
        <div class="card rounded-5 mt-5 mb-5 shadow-lg">
            <h2 class="card-b_img header rounded-5 p-3 text-center bg-secondary text-white">Edit Book Details</h2>
            <div class="card-body">
                <form id="add_book_form" method="POST" action="{{route('editbook',['ubid'=>$book->id])}}" enctype="multipart/form-data">
                    @csrf
                    <div class="mb-3 mt-3">
                    ...
                    <div class="mb-3 mt-3">
                        ...
                        <input type="text" class="form-control" id="b_pages" placeholder="Enter No. Book Pages" name="b_pages" onkeypress="return(event.charCode>47 && event.charCode<58)" value="{{$book->book_pages}}">
                    ...
                    <div class="mb-3 mt-3">
                        ...
                        <input type="file" class="form-control" id="b_img" placeholder="Upload Image of Book" name="b_img" value="{{$book->book_image}}">
                        @if ($errors->has('b_img'))
                    ...
                    <div class="mb-3 mt-3">
                        ...
                        <input type="text" class="form-control" id="b_isbn" placeholder="Enter Book ISBN" name="b_isbn" onkeypress="return(event.charCode>47 && event.charCode<58)" value="{{$book->book_isbn}}">
                    ...
                    <div class="mb-3 mt-3">
                        ...
                        <input type="number" class="form-control" id="b_price" placeholder="Enter Book Price" name="b_price" onkeypress="return(event.charCode>47 && event.charCode<58) || (event.charCode==46)" value="{{$book->book_price}}">
                        ...
                        <div class="row">
                            ...
                            <div class="col-2">
                                <div class="form-check form-switch">
                                    <input class="form-check-input" type="checkbox" role="switch" id="b_status"  value="1" {{($book->book_status==1)==1? "checked":""}} name="b_status">
                                    <label class="form-check-label" for="flexSwitchCheckChecked">Active</label>
                                </div>
                            </div>
                        </div>
                    </div>
                    <button type="submit" class="btn btn-primary" id="add_book" name="add_book">Update
                        Book</button>
                    <a type="button" href="{{route('bookslist')}}" class="btn btn-danger" id="b_cancel"
